...
from config.constants import (
    ...
    MAX_FETCH_NODES, MAX_PROXY_TEST_NODES, MAX_FINAL_NODES,
    MAX_LATENCY, MIN_PROXY_SPEED, MAX_PROXY_LATENCY,
...
if __name__ == "__main__":
    # v30.6: 代理由 network/client.py 的 _detect_proxy() 自动检测
    # 不再设置 HTTP_PROXY/HTTPS_PROXY 环境变量，避免 CI 环境误连
    try:
        main()
